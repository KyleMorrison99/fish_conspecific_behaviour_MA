...
lnRR_pesticide_orchard <- list(
  mod_table = lnRR_pesticide_mod_results_filter,
  data = lnRR_pesticide_data_filter
)

# Assign the appropriate classes to the object
class(lnRR_pesticide_orchard) <- c("orchard", "data.frame")


pesticide.mod.lnRR <- orchaRd::orchard_plot(lnRR_pesticide_orchard,
                      group = "study_id", 
                      xlab = "lnRR",
                      data = data,
...
lnVR_pesticide_orchard <- list(
  mod_table = lnVR_pesticide_mod_results_filter,
  data = lnVR_pesticide_data_filter
)
class(lnVR_pesticide_orchard) <- c("orchard", "data.frame")

pesticide.mod.lnVR <- orchaRd::orchard_plot(lnVR_pesticide_orchard,
             group = "study_id", 
             xlab = "lnVR",
             data = data,
             mod = "pesticide_chemical_class",
...
pesticide.mod.lnRR2 <- orchaRd::orchard_plot(lnRR_mod_pesticide,
             group = "study_id", 
             xlab = "lnVR",
             data = data,
             mod = "pesticide_chemical_class",
...
pesticide.mod.lnVR2 <- orchaRd::orchard_plot(lnVR_mod_pesticide,
             group = "study_id", 
             xlab = "lnVR",
             data = data,
             mod = "pesticide_chemical_class",
...
main_text_figure_4 <- pesticide.mod.lnRR + pesticide.mod.lnVR 


# ggsave(here("figures", "main_text_figure_4.jpg"),width = 24, height = 17, units = "cm", dpi = 800)
# ggsave(here("figures", "main_text_figure_4.pdf"),width = 24, height = 17, units = "cm", dpi = 800)
...
species.mod.lnRR <- orchaRd::orchard_plot(lnRR_species_orchard,
             group = "study_id", 
             xlab = "lnRR",
             data = data,
             mod = "species_english",
...
# First plot (lnRR_mod_species)
species.mod.lnRR2 <- orchaRd::orchard_plot(lnRR_mod_species,
             group = "study_id", 
             xlab = "lnRR",
             data = data,
             mod = "species_english",
...
# First plot (lnRR_mod_species)
species.mod.lnVR <- orchaRd::orchard_plot(lnVR_species_orchard,
             group = "study_id", 
             xlab = "lnVR",
             data = data,
             mod = "species_english",
...
species.mod.lnVR2 <- orchaRd::orchard_plot(lnVR_mod_species,
             group = "study_id", 
             xlab = "lnVR",
             data = data,
             mod = "species_english",
...
# Combine the plots
main_text_figure_5 <- species.mod.lnRR + species.mod.lnVR

# Save the plots
# ggsave(here("figures", "species_plot_figure.jpg"), plot = main_text_figure_5,width = 24, height = 14, units = "cm", dpi = 800)
# ggsave(here("figures", "species_plot_figure.pdf"), plot = main_text_figure_5, width = 24, height = 14, units = "cm", dpi = 800)
