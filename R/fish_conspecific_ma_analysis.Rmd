...
```{r}
# Calculate the number of "not reported" values for control_sd and treatment_sd
sum(data$control_sd == "not reported", na.rm = TRUE) # 18
sum(data$treatment_sd == "not reported", na.rm = TRUE) # 18
